...
const CATEGORIES: Array<{
  ...
  {
    id: "advanced-boosters",
    title: "Advanced Boosters",
    description: "Adaptogenic add-ons to support stress response, stamina, and recovery.",
    recipes: [
      {
        id: "rhodiola-sunrise",
        name: "Rhodiola Sunrise Blend",
        description: "Bright mango smoothie infused with rhodiola for stamina and focus.",
        macros: { calories: 215, protein: 9, carbs: 34 },
        saves: 121,
        color: "#ffecb3",
        ingredientIds: ["mango", "banana", "protein-powder"],
        boosterIds: ["booster-protein"],
        ingredients: [
          "1 cup mango",
          "1/2 banana",
        ...
        boosters: ["Add maca for extra endurance", "Top with dried mango"],
        steps: [
          "Blend mango, banana, and coconut water.",
          "Add protein and rhodiola; blend briefly.",
          "Serve cold with dried mango garnish.",
        ],
      },
      {
        id: "ashwagandha-calm-refuel",
        name: "Ashwagandha Calm Refuel",
        description: "Creamy almond smoothie with ashwagandha to unwind and recover.",
        macros: { calories: 240, protein: 14, carbs: 20 },
        saves: 134,
        color: "#d7ccc8",
        ...
        boosters: ["Add collagen for joint support", "Top with toasted almonds"],
        steps: [
          "Blend banana, yogurt, and almond butter until smooth.",
          "Add ashwagandha and cinnamon; pulse lightly.",
          "Serve warm or chilled with almond topping.",
        ],
      },
      {
        id: "cordyceps-endurance",
        name: "Cordyceps Endurance Shake",
        description: "Chocolate performance shake boosted with cordyceps for stamina.",
        macros: { calories: 285, protein: 20, carbs: 29 },
        saves: 118,
        color: "#a1887f",
        ingredientIds: ["banana", "protein-powder", "peanut-butter"],
        boosterIds: ["booster-protein"],
        ...
        boosters: ["Add chia for extra carbs", "Top with cacao nibs"],
        steps: [
          "Blend banana, protein, and oat milk until smooth.",
          "Add peanut butter and cordyceps; blend again.",
          "Serve over ice with cacao nibs.",
        ],
      },
    ],
  },
