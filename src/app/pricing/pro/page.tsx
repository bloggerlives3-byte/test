...
const ProTierPage = () => {
  const tier = getPricingTierById("pro");
    ...
    <div className="mx-auto max-w-3xl px-4 py-16">
      ...
      <section className="mt-10 rounded-3xl border border-[color:var(--color-accent-mango)]/40 bg-[color:var(--color-accent-mango)]/10 p-6 text-sm text-[color:var(--color-foreground)]/80">
        ...
        <ul className="mt-2 list-disc space-y-1 pl-5">
          <li>Nutritionists managing multiple clients and goals</li>
          <li>Fitness coaches running smoothie challenges</li>
          <li>Studios offering branded nutrition programs</li>
        </ul>
      </section>
